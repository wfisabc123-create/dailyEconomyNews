...
function getDynamicFallbackEvents() {
  ...
  const standardEvents = [
    { dayOffset: 0, time: '08:30', country: '한국', title: '경제관계장관회의 / 물가 민생 점검', impact: 'Medium', desc: '물가·민생 관련 부처 일정' },
    { dayOffset: 0, time: '21:30', country: '미국', title: '미국 주요 경제지표 발표', impact: 'High', desc: '고용·물가·소비 지표 발표' },
    { dayOffset: 1, time: '10:00', country: '한국', title: '한국은행 금융통화위원회 및 금융시장 동향', impact: 'High', desc: '통화정책 방향 및 시장 유동성 점검' },
    { dayOffset: 1, time: '21:30', country: '미국', title: '미국 신규 실업수당 청구건수', impact: 'Medium', desc: '주간 고용 지표' },
    { dayOffset: 2, time: '03:00', country: '미국', title: 'FOMC 통화정책 및 글로벌 중앙은행 동향', impact: 'High', desc: '글로벌 금리 및 유동성 방향성' }
  ];
